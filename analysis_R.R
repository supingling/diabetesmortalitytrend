...
nrow(db)
attach(db)
db$ageout <- db$agein + (db$outm - db$yearin)
...
dbs11  <-splitMulti(db11, age = seq(30,max(db$ageout)+1,1), period= seq(1998,max(db$outm)+1,1))
...
dbs12  <-splitMulti(db12, age = seq(30,max(db$ageout)+1,1), period= seq(1998,max(db$outm)+1,1))
...
dbs01  <-splitMulti(db01, age = seq(30,max(db$ageout)+1,1), period= seq(1998,max(db$outm)+1,1))
...
dbs02  <-splitMulti(db02, age = seq(30,max(db$ageout)+1,1), period= seq(1998,max(db$outm)+1,1))
